...
public class EmailServiceImpl implements EmailService {
	...
	@KafkaListener(topics = "forgot-password", containerFactory = "emailForgotPasswordContainerFactory")
	@Override
	public void sendEmailForgotPassword(EmailForgotPasswordDto dto) {
		String urlVerify = "http://localhost:3000/forgot-password/" + dto.getCode();
		
		Map<String, Object> attributes = new HashMap<String, Object>();
		attributes.put("newPassword", dto.getNewPassword());
		attributes.put("urlVerify", urlVerify);
		
		sendMessageHtml(dto.getTo(), "Forgot password", "reset-password", attributes);
	}
}
